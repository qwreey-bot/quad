...
없음(`.claude/todos.md` 00번(옛 1번 — 2026-09-06 구현 착수 항목은 마일스톤 완료로 지워짐) — 구현 착수가 최우선). 이 0번 항목은
...
셋 다 지금 당장 설계할 필요는 없음(`.claude/todos.md` 00번(옛 1번 — 2026-09-06 구현 착수 항목은 마일스톤 완료로 지워짐) —
